package com.yizhun.health.tech.module.ai.framework.ai.core.model;
...
import com.yizhun.health.tech.framework.common.util.spring.SpringUtils;
import com.yizhun.health.tech.module.ai.enums.model.AiPlatformEnum;
import com.yizhun.health.tech.module.ai.framework.ai.config.AiAutoConfiguration;
import com.yizhun.health.tech.module.ai.framework.ai.config.YizhunhtAiProperties;
...
import com.yizhun.health.tech.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.yizhun.health.tech.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            YizhunhtAiProperties.Midjourney properties = SpringUtil.getBean(YizhunhtAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(YizhunhtAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        YizhunhtAiProperties.DouBao properties = new YizhunhtAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(YizhunhtAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        YizhunhtAiProperties.HunYuan properties = new YizhunhtAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(YizhunhtAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        YizhunhtAiProperties.SiliconFlow properties = new YizhunhtAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(YizhunhtAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        YizhunhtAiProperties.XingHuo properties = new YizhunhtAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(YizhunhtAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        YizhunhtAiProperties.BaiChuan properties = new YizhunhtAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(YizhunhtAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        YizhunhtAiProperties.Gemini properties = SpringUtil.getBean(YizhunhtAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        YizhunhtAiProperties.Grok properties = new YizhunhtAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
