package com.yizhun.health.tech.module.ai.service.chat;
...
import com.yizhun.health.tech.framework.tenant.core.util.TenantUtils;
import com.yizhun.health.tech.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.yizhun.health.tech.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.yizhun.health.tech.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.yizhun.health.tech.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.yizhun.health.tech.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.yizhun.health.tech.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.yizhun.health.tech.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.yizhun.health.tech.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.yizhun.health.tech.module.ai.dal.dataobject.model.AiModelDO;
import com.yizhun.health.tech.module.ai.dal.dataobject.model.AiToolDO;
import com.yizhun.health.tech.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.yizhun.health.tech.module.ai.enums.ErrorCodeConstants;
import com.yizhun.health.tech.module.ai.enums.model.AiPlatformEnum;
import com.yizhun.health.tech.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.yizhun.health.tech.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.yizhun.health.tech.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.yizhun.health.tech.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.yizhun.health.tech.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.yizhun.health.tech.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.yizhun.health.tech.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.yizhun.health.tech.module.ai.service.model.AiChatRoleService;
import com.yizhun.health.tech.module.ai.service.model.AiModelService;
import com.yizhun.health.tech.module.ai.service.model.AiToolService;
import com.yizhun.health.tech.module.ai.util.AiUtils;
import com.yizhun.health.tech.module.ai.util.FileTypeUtils;
...
import static com.yizhun.health.tech.framework.common.pojo.CommonResult.error;
import static com.yizhun.health.tech.framework.common.pojo.CommonResult.success;
import static com.yizhun.health.tech.framework.common.util.collection.CollectionUtils.convertList;
import static com.yizhun.health.tech.framework.common.util.collection.CollectionUtils.convertSet;
import static com.yizhun.health.tech.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.yizhun.health.tech.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 yizhunht.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 yizhunht.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
