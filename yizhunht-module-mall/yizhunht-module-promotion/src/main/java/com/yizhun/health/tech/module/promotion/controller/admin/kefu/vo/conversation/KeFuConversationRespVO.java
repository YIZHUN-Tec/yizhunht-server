package com.yizhun.health.tech.module.promotion.controller.admin.kefu.vo.conversation;
...
public class KeFuConversationRespVO {
    ...
    private Long userId;
    @Schema(description = "会话所属用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://yizhunht.com/images/avatar.jpg")
