package com.yizhun.health.tech.module.trade.controller.admin.config.vo;
...
public class TradeConfigBaseVO {
    ...
    @Schema(description = "分销海报图地址数组", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.iocoder.cn/yizhunht.jpg]")
