package com.yizhun.health.tech.module.trade.convert.order;
...
import com.yizhun.health.tech.framework.common.util.string.StrUtils;
import com.yizhun.health.tech.framework.dict.core.DictFrameworkUtils;
import com.yizhun.health.tech.framework.ip.core.utils.AreaUtils;
import com.yizhun.health.tech.module.member.api.address.dto.MemberAddressRespDTO;
import com.yizhun.health.tech.module.member.api.user.dto.MemberUserRespDTO;
import com.yizhun.health.tech.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.yizhun.health.tech.module.pay.enums.DictTypeConstants;
import com.yizhun.health.tech.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.yizhun.health.tech.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.yizhun.health.tech.module.product.api.sku.dto.ProductSkuRespDTO;
import com.yizhun.health.tech.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.yizhun.health.tech.module.product.api.spu.dto.ProductSpuRespDTO;
import com.yizhun.health.tech.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.yizhun.health.tech.module.trade.api.order.dto.TradeOrderRespDTO;
import com.yizhun.health.tech.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.yizhun.health.tech.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.yizhun.health.tech.module.trade.controller.admin.order.vo.*;
import com.yizhun.health.tech.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.yizhun.health.tech.module.trade.controller.app.order.vo.*;
import com.yizhun.health.tech.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.yizhun.health.tech.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.yizhun.health.tech.module.trade.dal.dataobject.order.TradeOrderLogDO;
import com.yizhun.health.tech.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import com.yizhun.health.tech.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.yizhun.health.tech.module.trade.framework.order.config.TradeOrderProperties;
import com.yizhun.health.tech.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.yizhun.health.tech.framework.common.util.collection.CollectionUtils.convertMap;
import static com.yizhun.health.tech.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static com.yizhun.health.tech.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/yizhunhtcode/yizhunht-mall-uniapp/issues/ICY7SJ
