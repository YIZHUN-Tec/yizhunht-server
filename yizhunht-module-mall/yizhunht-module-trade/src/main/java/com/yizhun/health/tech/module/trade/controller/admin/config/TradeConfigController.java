package com.yizhun.health.tech.module.trade.controller.admin.config;

import com.yizhun.health.tech.framework.common.pojo.CommonResult;
import com.yizhun.health.tech.module.trade.controller.admin.config.vo.TradeConfigRespVO;
import com.yizhun.health.tech.module.trade.controller.admin.config.vo.TradeConfigSaveReqVO;
import com.yizhun.health.tech.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${yizhunht.tencent-lbs-key}")
