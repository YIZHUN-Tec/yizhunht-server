package com.yizhun.health.tech.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.yizhun.health.tech.framework.common.enums.CommonStatusEnum;
import com.yizhun.health.tech.framework.common.exception.ServiceException;
import com.yizhun.health.tech.framework.common.pojo.PageResult;
import com.yizhun.health.tech.framework.common.util.collection.ArrayUtils;
import com.yizhun.health.tech.framework.common.util.collection.CollectionUtils;
import com.yizhun.health.tech.framework.test.core.ut.BaseDbUnitTest;
import com.yizhun.health.tech.module.infra.api.config.ConfigApi;
import com.yizhun.health.tech.module.infra.api.file.FileApi;
import com.yizhun.health.tech.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.yizhun.health.tech.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.yizhun.health.tech.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.yizhun.health.tech.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.yizhun.health.tech.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.yizhun.health.tech.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.yizhun.health.tech.module.system.dal.dataobject.dept.DeptDO;
import com.yizhun.health.tech.module.system.dal.dataobject.dept.PostDO;
import com.yizhun.health.tech.module.system.dal.dataobject.dept.UserPostDO;
import com.yizhun.health.tech.module.system.dal.dataobject.tenant.TenantDO;
import com.yizhun.health.tech.module.system.dal.dataobject.user.AdminUserDO;
import com.yizhun.health.tech.module.system.dal.mysql.dept.UserPostMapper;
import com.yizhun.health.tech.module.system.dal.mysql.user.AdminUserMapper;
import com.yizhun.health.tech.module.system.enums.common.SexEnum;
import com.yizhun.health.tech.module.system.service.dept.DeptService;
import com.yizhun.health.tech.module.system.service.dept.PostService;
import com.yizhun.health.tech.module.system.service.oauth2.OAuth2TokenService;
import com.yizhun.health.tech.module.system.service.permission.PermissionService;
import com.yizhun.health.tech.module.system.service.tenant.TenantService;
...
import static com.yizhun.health.tech.framework.common.util.collection.SetUtils.asSet;
import static com.yizhun.health.tech.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.yizhun.health.tech.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.yizhun.health.tech.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.yizhun.health.tech.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.yizhun.health.tech.framework.test.core.util.AssertUtils.assertServiceException;
import static com.yizhun.health.tech.framework.test.core.util.RandomUtils.*;
import static com.yizhun.health.tech.module.system.enums.ErrorCodeConstants.*;
import static com.yizhun.health.tech.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("yizhunhtyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("yizhunhtyuanma");
        ...
        assertEquals("yizhunhtyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("yizhunhtyuanma"))).thenReturn("java");
