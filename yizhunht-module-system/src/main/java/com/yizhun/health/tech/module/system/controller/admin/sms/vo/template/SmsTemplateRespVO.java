package com.yizhun.health.tech.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "yizhunht")
    @ExcelProperty("模板名称")
    private String name;
