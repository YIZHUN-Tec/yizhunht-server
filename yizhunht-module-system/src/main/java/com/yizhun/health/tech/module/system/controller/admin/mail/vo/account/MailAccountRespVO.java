package com.yizhun.health.tech.module.system.controller.admin.mail.vo.account;
...
public class MailAccountRespVO {
    ...
    @Schema(description = "邮箱", requiredMode = Schema.RequiredMode.REQUIRED, example = "yizhunhtyuanma@123.com")
    private String mail;

    @Schema(description = "用户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "yizhunht")
