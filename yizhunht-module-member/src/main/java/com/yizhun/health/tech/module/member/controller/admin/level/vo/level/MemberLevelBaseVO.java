package com.yizhun.health.tech.module.member.controller.admin.level.vo.level;
...
public class MemberLevelBaseVO {
    ...
    @Schema(description = "等级图标", example = "https://www.iocoder.cn/yizhunht.jpg")
    @URL(message = "等级图标必须是 URL 格式")
    private String icon;

    @Schema(description = "等级背景图", example = "https://www.iocoder.cn/yizhunht.jpg")
