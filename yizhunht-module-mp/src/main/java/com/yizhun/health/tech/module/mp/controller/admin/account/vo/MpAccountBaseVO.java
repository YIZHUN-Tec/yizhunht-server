package com.yizhun.health.tech.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号微信号", requiredMode = Schema.RequiredMode.REQUIRED, example = "yizhunhtyuanma")
