package com.yizhun.health.tech.module.iot.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * VALUE 数据类型：String 数组(JSON)，即 {@link com.yizhun.health.tech.module.iot.dal.dataobject.thingmodel.IotThingModelDO} 列表
     */
     ...
     * VALUE 数据类型：String 数组(JSON)，即 {@link com.yizhun.health.tech.module.iot.dal.dataobject.rule.IotDataRuleDO} 列表
     */
     ...
     * VALUE 数据类型：String(JSON)，即 {@link com.yizhun.health.tech.module.iot.dal.dataobject.rule.IotDataSinkDO}
     */
     ...
     * VALUE 数据类型：String 数组(JSON)，即 {@link com.yizhun.health.tech.module.iot.dal.dataobject.rule.IotSceneRuleDO} 列表
     */
