package com.yizhun.health.tech.module.iot.api.device;

import com.yizhun.health.tech.framework.common.enums.RpcConstants;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 yizhunht-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
