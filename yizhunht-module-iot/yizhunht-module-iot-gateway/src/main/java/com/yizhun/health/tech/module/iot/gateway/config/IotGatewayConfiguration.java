package com.yizhun.health.tech.module.iot.gateway.config;

import com.yizhun.health.tech.module.iot.core.messagebus.core.IotMessageBus;
import com.yizhun.health.tech.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import com.yizhun.health.tech.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import com.yizhun.health.tech.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import com.yizhun.health.tech.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import com.yizhun.health.tech.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import com.yizhun.health.tech.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import com.yizhun.health.tech.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import com.yizhun.health.tech.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import com.yizhun.health.tech.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import com.yizhun.health.tech.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import com.yizhun.health.tech.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import com.yizhun.health.tech.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import com.yizhun.health.tech.module.iot.gateway.service.device.IotDeviceService;
import com.yizhun.health.tech.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "yizhunht.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "yizhunht.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "yizhunht.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "yizhunht.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
