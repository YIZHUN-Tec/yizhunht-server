package com.yizhun.health.tech.module.iot.core.messagebus.config;

import com.yizhun.health.tech.framework.mq.redis.core.RedisMQTemplate;
import com.yizhun.health.tech.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.yizhun.health.tech.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.yizhun.health.tech.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.yizhun.health.tech.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.yizhun.health.tech.module.iot.core.messagebus.core.IotMessageBus;
import com.yizhun.health.tech.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.yizhun.health.tech.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.yizhun.health.tech.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "yizhunht.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "yizhunht.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 YizhunhtRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.yizhun.health.tech.framework.mq.redis.config.YizhunhtRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "yizhunht.iot.message-bus", name = "type", havingValue = "redis")
