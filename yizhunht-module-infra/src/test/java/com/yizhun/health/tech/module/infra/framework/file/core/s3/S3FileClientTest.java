package com.yizhun.health.tech.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("yizhunhtyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.yizhunht.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.yizhunht.iocoder.cn
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://t151glocd.hn-bkt.clouddn.com"); // 如果有自定义域名，则可以设置。http://static.yizhunht.iocoder.cn
        config.setEnablePathStyleAccess(false);
        // 默认上海的 endpoint
        config.setEndpoint("s3-cn-south-1.qiniucs.com");
