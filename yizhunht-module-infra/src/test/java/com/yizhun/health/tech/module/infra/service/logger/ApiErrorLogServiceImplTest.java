package com.yizhun.health.tech.module.infra.service.logger;
...
import com.yizhun.health.tech.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.yizhun.health.tech.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.yizhun.health.tech.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.yizhun.health.tech.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.yizhun.health.tech.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.yizhun.health.tech.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("yizhunht-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("yizhunht-test");
