package com.yizhun.health.tech.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.yizhun.health.tech.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
