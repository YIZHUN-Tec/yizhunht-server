package com.yizhun.health.tech.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableSaveReqVO {
    ...
    @Schema(description = "表名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "yizhunht")
