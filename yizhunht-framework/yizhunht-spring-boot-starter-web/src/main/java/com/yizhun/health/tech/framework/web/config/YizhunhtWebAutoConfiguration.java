package com.yizhun.health.tech.framework.web.config;
...
import com.yizhun.health.tech.framework.web.core.filter.CacheRequestBodyFilter;
import com.yizhun.health.tech.framework.web.core.filter.DemoFilter;
import com.yizhun.health.tech.framework.web.core.handler.GlobalExceptionHandler;
import com.yizhun.health.tech.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YizhunhtWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "yizhunht.demo", havingValue = "true")
