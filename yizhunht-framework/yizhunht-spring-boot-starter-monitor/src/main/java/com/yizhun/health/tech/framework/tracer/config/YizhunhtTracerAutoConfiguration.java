...
import com.yizhun.health.tech.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "yizhunht.tracer", value = "enable", matchIfMissing = true)
public class YizhunhtTracerAutoConfiguration {
