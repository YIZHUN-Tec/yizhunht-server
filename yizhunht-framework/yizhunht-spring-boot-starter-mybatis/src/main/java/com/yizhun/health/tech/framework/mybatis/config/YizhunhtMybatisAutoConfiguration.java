package com.yizhun.health.tech.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.yizhun.health.tech.framework.common.util.json.JsonUtils;
import com.yizhun.health.tech.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${yizhunht.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class YizhunhtMybatisAutoConfiguration {
