package com.yizhun.health.tech.module.pay.framework.pay.core.client.impl.weixin;
...
import com.yizhun.health.tech.framework.common.util.io.FileUtils;
...
import static com.yizhun.health.tech.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.yizhun.health.tech.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/yizhunhtcode/yizhunht-ui-admin-vue3/issues/ICUE53 和 https://t.zsxq.com/ODR5V
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/yizhunht-cloud/issues/ICSFL6
