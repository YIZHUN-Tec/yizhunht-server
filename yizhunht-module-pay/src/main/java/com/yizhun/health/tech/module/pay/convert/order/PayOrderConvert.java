package com.yizhun.health.tech.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.yizhun.health.tech.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
