...
import com.yizhun.health.tech.framework.common.util.date.LocalDateTimeUtils;
...
import com.yizhun.health.tech.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
...
import com.yizhun.health.tech.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/yizhunht-cloud/issues/I8SM9H 场景
