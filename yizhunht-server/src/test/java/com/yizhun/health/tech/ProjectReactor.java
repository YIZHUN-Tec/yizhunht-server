package com.yizhun.health.tech;
...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.yizhun.health.tech";
    private static final String ARTIFACT_ID = "yizhunht";
    private static final String PACKAGE_NAME = "com.yizhun.health.tech";
    private static final String TITLE = "健康管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.yizhun.health.tech";
        String artifactIdNew = "yizhunht";
        String packageNameNew = "com.yizhun.health.tech";
        String titleNew = "健康管理系统";
