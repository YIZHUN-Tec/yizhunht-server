package com.yizhun.health.tech.module.bpm.service.task;
...
import com.yizhun.health.tech.framework.common.util.collection.CollectionUtils;
import com.yizhun.health.tech.framework.common.util.date.DateUtils;
import com.yizhun.health.tech.framework.common.util.json.JsonUtils;
import com.yizhun.health.tech.framework.common.util.object.ObjectUtils;
import com.yizhun.health.tech.framework.common.util.object.PageUtils;
import com.yizhun.health.tech.framework.datapermission.core.annotation.DataPermission;
import com.yizhun.health.tech.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.yizhun.health.tech.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.yizhun.health.tech.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.yizhun.health.tech.module.bpm.controller.admin.task.vo.instance.*;
import com.yizhun.health.tech.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.yizhun.health.tech.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.yizhun.health.tech.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.yizhun.health.tech.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.yizhun.health.tech.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.yizhun.health.tech.module.bpm.enums.ErrorCodeConstants;
import com.yizhun.health.tech.module.bpm.enums.definition.BpmModelTypeEnum;
import com.yizhun.health.tech.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.yizhun.health.tech.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.yizhun.health.tech.module.bpm.enums.task.BpmReasonEnum;
import com.yizhun.health.tech.module.bpm.enums.task.BpmTaskStatusEnum;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.yizhun.health.tech.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.yizhun.health.tech.module.bpm.service.definition.BpmProcessDefinitionService;
import com.yizhun.health.tech.module.bpm.service.message.BpmMessageService;
import com.yizhun.health.tech.module.system.api.dept.DeptApi;
import com.yizhun.health.tech.module.system.api.dept.dto.DeptRespDTO;
import com.yizhun.health.tech.module.system.api.user.AdminUserApi;
import com.yizhun.health.tech.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.yizhun.health.tech.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.yizhun.health.tech.module.bpm.enums.ErrorCodeConstants.*;
import static com.yizhun.health.tech.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.yizhun.health.tech.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/yizhunht-cloud/issues/ID1UYA
