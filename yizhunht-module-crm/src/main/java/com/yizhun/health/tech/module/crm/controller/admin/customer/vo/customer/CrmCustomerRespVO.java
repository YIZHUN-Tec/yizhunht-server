...
import com.yizhun.health.tech.module.infra.enums.DictTypeConstants;
...
public class CrmCustomerRespVO {
    ...
    @DictFormat(com.yizhun.health.tech.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY)
    private Integer industryId;

    @Schema(description = "客户等级", requiredMode = Schema.RequiredMode.REQUIRED, example = "13563")
    @ExcelProperty(value = "客户等级", converter = DictConvert.class)
    @DictFormat(com.yizhun.health.tech.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_LEVEL)
    private Integer level;

    @Schema(description = "客户来源", requiredMode = Schema.RequiredMode.REQUIRED, example = "13563")
    @ExcelProperty(value = "客户来源", converter = DictConvert.class)
    @DictFormat(com.yizhun.health.tech.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_SOURCE)
